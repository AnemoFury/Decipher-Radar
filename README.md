...
## Resume Bullet
> "Architected a scalable e-commerce backend using **Java (Spring Boot)** and **MySQL**; deployed the microservice via **Docker** on **Kubernetes**, demonstrating strong OOPS and system design fundamentals."
